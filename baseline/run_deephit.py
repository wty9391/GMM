...
class DeepHit:
    def __init__(self, lr, batch_size, dimension, util_train, util_test, campaign, reg_lambda, sigma):
        ...
        # placeholders
        self.X = [tf.sparse_placeholder(tf.float64, name='x_%d'%i) for i in range(0, self.field_num)]
...
if __name__ == '__main__':
    ...
    os.environ["CUDA_VISIBLE_DEVICES"] = random.choice(['2'])
    campaign_list = ['2997']#['2997', '2259', '3476', '1458', '3386', '3427', '2261', '2821', '3358']
