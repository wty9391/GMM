...
class SparseData():
    ...
    def __init__(self, INPUT_FILE, win, all, discount, test=False):
        self.data = []
        self.labels = []
        self.seqlen = []
        self.market_price = []
        ...
        for line in fi:
            ...
            if all:
                if test:
                    ...
                    self.labels.append([0., 0.])  # duplicated
                else:
...
class BASE_RNN():
    ...
    def __init__(self,  EMB_DIM = 32,
        ...
        self.TRAIN_FILE = "../result/" + INPUT_FILE + "/train.yzbx.txt"
        self.TEST_FILE = "../result/" + INPUT_FILE + "/test.yzbx.txt"
    ...
    def load_data(self):
        ...
        self.test_data = SparseData(self.TEST_FILE, False, True, self.DISCOUNT, test=True)
